...
class FaceTrackerFactory implements MultiProcessor.Factory<Face> {
    ...
    private ITrackerProcess<Face> iTrackerProcess;

    FaceTrackerFactory(GraphicOverlay graphicOverlay, ITrackerProcess<Face> iTrackerProcess) {
    ...
    public Tracker<Face> create(Face face) {
        ...
        return new GraphicTracker<>(mGraphicOverlay, graphic, this.iTrackerProcess);
    }
}
